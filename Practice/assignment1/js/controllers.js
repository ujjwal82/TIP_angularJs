	...
	.controller('myCtrl',['$scope', function($scope){
		...
		$scope.records = [	{recID: 101, name : "Ujjwal Kumar", age : 35, company : "FIS"}, 
						    {recID: 102, name : "Swapnil Joshi", age : 34, company : "FIS"}, 
						    {recID: 103, name : "Shivraj Pachling", age : 36, company : "FIS"},
						    {recID: 104, name : "Sandeep Vaid", age : 33, company : "WMH"},
						    {recID: 105, name : "Sandeep Pandit", age : 34, company : "CTS"},
						    {recID: 106, name : "Shekahr Dhupkar", age : 33, company : "TCS"},
						    {recID: 107, name : "Vijay Kulkarni", age : 35, company : "HSBC"}
						  ];
